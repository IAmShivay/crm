...
const themeSlice = createSlice({
  ...
  reducers: {
    ...
    updateThemeColors: (state, action: PayloadAction<Partial<CustomTheme['colors']>>) => {
      state.customTheme.colors = { ...state.customTheme.colors, ...action.payload };
      state.preset = 'custom';
    },
    updateTypography: (state, action: PayloadAction<Partial<CustomTheme['typography']>>) => {
      state.customTheme.typography = { ...state.customTheme.typography, ...action.payload };
    },
    updateSpacing: (state, action: PayloadAction<Partial<CustomTheme['spacing']>>) => {
      state.customTheme.spacing = { ...state.customTheme.spacing, ...action.payload };
    },
    setBorderRadius: (state, action: PayloadAction<CustomTheme['borderRadius']>) => {
