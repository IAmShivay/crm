...
export const userPreferencesApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    updateUserPreferences: builder.mutation<PreferencesResponse, UserPreferences>({
      query: (preferences) => ({
        url: '',
        method: 'PUT',
        body: preferences,
    ...
    patchUserPreferences: builder.mutation<PreferencesResponse, Partial<UserPreferences>>({
      query: (preferences) => ({
        url: '',
        method: 'PATCH',
        body: preferences,
