      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className={`flex items-center space-x-1 text-xs ${
                analyticsData.leads.trend === 'up' ? 'text-green-600' : 'text-red-600'
              }`}>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className={`flex items-center space-x-1 text-xs ${
                analyticsData.conversion.trend === 'up' ? 'text-green-600' : 'text-red-600'
              }`}>
            ...
            <div className="text-xs text-gray-500">
              vs {formatPercentage(analyticsData.conversion.previous)} last month
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className={`flex items-center space-x-1 text-xs ${
                ...
                <span>{formatPercentage(Math.abs(analyticsData.customers.change))}</span>
              </div>
            </div>
            <div className="text-2xl font-bold">
          ...
          <div className="grid grid-cols-3 gap-4">
            {quickStats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className={`inline-flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-800 mb-2`}>
        ...
        <div className="border-t pt-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Lead Quality</span>
              <div className="flex items-center space-x-2">
                <div className="w-20 bg-gray-200 rounded-full h-2">
