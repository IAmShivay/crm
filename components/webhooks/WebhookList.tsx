...
export function WebhookList({ onCreateWebhook, onEditWebhook }: WebhookListProps) {
  ...
  const getWebhookTypeConfig = (type: string) => {
    return webhookTypeConfigs[type as keyof typeof webhookTypeConfigs] || webhookTypeConfigs.custom;
  };

  const getSuccessRate = (webhook: any) => {
    if (webhook.totalRequests === 0) return 0;
    return Math.round((webhook.successfulRequests / webhook.totalRequests) * 100);
  };
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-center mb-4">
              Create your first webhook to start receiving leads from external sources like Facebook, Google Forms, or custom integrations.
            </p>
            <Button onClick={onCreateWebhook}>
              <Plus className="h-4 w-4 mr-2" />
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => copyWebhookUrl(webhook.webhookUrl || '')}>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-sm font-medium">{webhook.totalRequests}</p>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-sm font-medium">{webhook.failedRequests}</p>
