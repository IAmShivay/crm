...
export function WebhookForm({ open, onClose, webhook }: WebhookFormProps) {
  ...
  const selectedConfig = webhookTypeConfigs[selectedType as keyof typeof webhookTypeConfigs];
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              {errors.events && (
                <p className="text-sm text-red-600 mt-2">{errors.events.message}</p>
              )}
            </CardContent>
          </Card>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      min="100"
                      max="60000"
                      {...register('retryConfig.retryDelay', { valueAsNumber: true })}
                    />
                  </div>
                </div>
              </CardContent>
