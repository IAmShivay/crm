        ...
        <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {pendingInvitations.map((invitation) => (
                    <div key={invitation.id} className="flex items-center space-x-2 p-2 bg-blue-50 rounded-md">
                      <Mail className="h-4 w-4 text-blue-500" />
                      <div className="flex-1">
                        <p className="text-sm font-medium">{invitation.workspaces?.name}</p>
                        <p className="text-xs text-gray-600">Role: {invitation.roles?.name}</p>
                      </div>
                ...
                <p className="text-xs text-blue-600">
                  These invitations will be automatically accepted when you complete setup.
                </p>
              </div>
            )}
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    {...register('workspaceName', { 
                      required: createWorkspace ? 'Workspace name is required' : false,
                      minLength: {
                        value: 2,
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-600">
              {!createWorkspace && 'You can join existing workspaces later via invitations'}
            </p>
          </div>
        </CardContent>
      </Card>
